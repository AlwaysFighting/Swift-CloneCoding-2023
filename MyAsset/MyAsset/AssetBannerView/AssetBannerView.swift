...
struct AssetBannerView: View {
    ...
    let bannerList: [AssetBanner] = [
        AssetBanner(title: "공지사항", descrioption: "추가된 공지사항을 확인하세요", backgroundColor: .red),
        AssetBanner(title: "주말 이벤트", descrioption: "주말 이벤트 놓치지 마세요.", backgroundColor: .yellow),
        AssetBanner(title: "깜짝 이벤트", descrioption: "엄청난 이벤트에 놀라지 마세요", backgroundColor: .blue),
        AssetBanner(title: "가을 프로모션", descrioption: "가을...🍂", backgroundColor: .brown)
    ]
